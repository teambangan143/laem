...
$query=mysqli_query($con,"update affiliateuser set password='$p1',address='$address',bankname='$bankname',accountname='$accname',accountno='$accno',accounttype='$acctype',email='$email',getpayment='$alwdpayment' where username='".$_SESSION['username']."'");
	...
	$wlink="$row121[wlink]";
		...
		$pathu="/app/signup2.php?laem=";			  ?>  
                  ...
                  <div class="panel-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>" method="post">
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" value="<?php print $username ?>" class="form-control" placeholder="Username" name="username" readonly>
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" value="<?php 
						 ...
						 $sqlcoun="SELECT name FROM provinces WHERE id=$contry";
		 ...
		 $province="$row2[name]";
						...
						print $province?>" class="form-control" placeholder="Province Name" name="contrydisplay" disabled>
...

{
  ...
  ?>
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" value="<?php print $email?>" class="form-control" placeholder="Email Address" name="email" required>
