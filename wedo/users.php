...
while($r = mysqli_fetch_array($re))
{
  ...
  print "<tr>
				  ...
				  <a href='updateuser.php?username=$username' class='label_edit bg-success'><span style='padding-bottom:10px;'>Edit</span></a><br/>
				  <a href='deleteuser.php?username=$username' class='label bg-danger'>Delete</a> <br/>
				  ";
				  
				  if($lprofile==0)
	{
	print "<br/><br/><a href='launchprofile.php?username=$username' class='btn btn-sm btn-info pull-right'>Launch</a>";
	}	  
