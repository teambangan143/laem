...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp" style="padding-top:10px;">
    <center><img src="images/wedo.png"></center>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>" method="post">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        ...
                        <input type="text" placeholder="Username" class="form-control no-border" name="username"
                               required>
                ...
                <div class="text-center m-t m-b"><a href="forgotpassword.php">
                        <small style="color:#ffffff;">Forgot password?</small>
                    </a> <!--| <a href="renewaccount.php"><small style="color:#ffffff;">Account Expired? Renew Here</small></a></div>

        <div class="line line-dashed"></div>

        <p class="text-center m-t m-b"><a href="#"><small style="color:#ffffff;">Don't Have Account?</small></a></p>

        <a href="signup2.php" class="btn btn-lg btn-default btn-block">Create an account</a>-->
...
<footer id="footer">
    ...
    <div class="text-center padder">
        ...
        <p>
            <small style="color:#ffffff;"><?php $query = "SELECT footer from settings where sno=0";
