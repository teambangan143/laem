...
$query=mysqli_query($con,"insert into affiliateuser(username,password,fname,mname,lname,address,email,referedby,ipaddress,mobile,doj,country,signupcode,tamount,pcktaken,expiry) values('$username','$password','$fname','$mname','$lname','$address','$email','$ref','$ip','$mobile','$cur','$country','$scode','$sbonus','$package','$expiry')");
...
<meta property="og:url" content="http://cmpcintl.com/user/" />
                    ...
                    <section class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" data-required="true" name="username" id="username" value="" >                        
                        ...
                        <div class="col-sm-6">
                         ...
                         <input type="text" class="form-control" data-required="true" name="fname" id="fname" oninput="join_names();" onpaste="join_names();" required>                          
                        ...
                        <div class="col-sm-6">
                         ...
                         <input type="text" class="form-control" data-required="true" name="mname" id="mname" oninput="join_names();" onpaste="join_names();" required>                          
                        ...
                        <div class="col-sm-6">
                         ...
                         <input type="text" class="form-control" data-required="true" name="lname" id="lname" oninput="join_names();" onpaste="join_names();" required>                          
   ...
   function join_names() {
    ...
    input_name_full.value = var_name_full;
						...
						<div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" data-type="phone" placeholder="(XXXX) XXX XXXX" data-required="true" name="mobile" required>
			...
			echo $_SESSION['aff']; } ?>" required>                        
                        ...
                        <div class="checkbox i-checks">
                          ...
                          <label>
                            ...
                            <input type="checkbox" name="check" data-required="true" required><i></i> I agree to the <a href="http://skinbotanicals.net/index.php?route=information/information&information_id=5" class="text-info">Terms of Service</a>
