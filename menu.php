...
<aside class="bg-light aside-md hidden-print" id="nav">
    ...
    <section class="vbox">
            ...
            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px"
                ...
                <div class="clearfix wrapper dk nav-user hidden-xs">
                    ...
                    <div class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span
                                    class="thumb avatar pull-left m-r"> <img src="images/a0.jpg"> <i
                                        class="on md b-black"></i> </span> <span class="hidden-nav-xs clear"> <span
                                        class="block m-t-xs"> <strong class="font-bold text-lt"><?php

                                        $sql = "SELECT fname,country,pcktaken,city FROM  affiliateuser WHERE username='" . $_SESSION['username'] . "'";
                                        ...
                                        ?></strong> <b class="caret"></b> </span> <span
                                        class="text-muted text-xs block"><?php print "LAEM Enterprises Member"; ?></span> </span>
                        </a>
                ...
                <nav class="nav-primary hidden-xs">
                    ...
                    <ul class="nav nav-main" data-ride="collapse">
                        ...
                        <li><a href="dashboard.php" class="auto"> <i class="i i-statistics icon"> </i> <span
                                        class="font-bold">Dashboard</span> </a></li>
                        <li><a href="placement.php" class="auto"> <i class="i i-statistics icon"> </i> <span
                                        class="font-bold">Placement</span> </a></li>


                        <!--
                                          <li > <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="i i-lab icon"> </i> <span class="font-bold">Earnings</span></a>
                                            <ul class="nav dk">
                        ...
                        <li> <a href="paymentshistory.php" class="auto"> <i class="i i-dot"></i> <span>Earning Reports</span> </a> </li>-->
        ...
        <footer class="footer hidden-xs no-padder text-center-nav-xs"><a href="logout.php" data-toggle="ajaxModal"
                                                                         class="btn btn-icon icon-muted btn-inactive pull-right m-l-xs m-r-xs hidden-nav-xs">
                <i class="i i-logout"></i> </a> <a href="#nav" data-toggle="class:nav-xs"
                                                   class="btn btn-icon icon-muted btn-inactive m-l-xs m-r-xs"> <i
                        class="i i-circleleft text"></i> <i class="i i-circleright text-active"></i> </a></footer>
