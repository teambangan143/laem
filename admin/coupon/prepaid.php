...
include_once ("../z_db.php");
	...
	/*	$id_number = $_POST['id_number'];
		...
		$coupons = coupon::generate_coupons($no_of_coupons, $length, $numbers, $mask);
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<form action="prepaid.php" method="post" id="coupon_form">
  ...
  ?>
                      ...
                      <tr>
						...
						<!--<tr>
							...
							<td>--><input class="form-control" type="hidden" name="length" value="10" min="1" /><!--</td>
						...
						<!--<tr>
							...
							<td>--><input class="form-control" type="hidden" name="prefix" placeholder="prefix-" /><!--</td>
						...
						<tr>
							...
							<td>--><input class="form-control" type="hidden" name="suffix" placeholder="-suffix" /><!--</td>
						...
						<!--<tr>
							...
							<td>--><input class="form-control" type="hidden" name="mask" value="XXXXXX-XXXX" /><!--</td>
