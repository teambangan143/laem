...
class coupon {
	...
	public static function generate($length=6, $prefix='', $suffix='', $numbers=true, $letters=true, $symbols=false, $random_register=false, $mask=false) {
		...
		$symbols = $symbols == 'false' ? true : false ;

		$random_register = $random_register == 'false' ? true : false ;
	...
	//public static function generate_coupons_to_xls($id_number='', $no_of_coupons=1, $length=6, $prefix='', $suffix='', $numbers=true, $letters=true, $symbols=false, $random_register=false, $mask=false) {
//
