...
<title>Maintenance Payment Requests Approval</title>
...

{
  ...
  $qum="SELECT * FROM  affiliateusermaintenance where memberID = $id"; 
...

{
	...
	$mainmemberid="$rm[memberID]";

	$mainamount="$rm[amount]";

	$mainshare="$rm[share]";

	$mainreleasedate="$rm[releasedate]";
	
	$maingetpayment="$rm[getpayment]";
  ...
  print "<tr>
	...
	print "<span class='label_edit bg-success'>Paid</span><br> <br>";
	...
	print "<a href='makepayment.php?payid=$prid' class='label_edit bg-success'><span style='padding-bottom:15px;'>Unpaid</span></a> <br> <br>";
