    ...
    while ($row = mysqli_fetch_row($result)) {
	   ...
	   ?></strong> <b class="caret"></b> </span> <span class="text-muted text-xs block">Web Administrator</span> </span> </a>
...
<!--
				  ...
				  <li > <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="fa fa-info-circle"> </i> <span class="font-bold">Analytics</span> </a>
                    ...
                    <ul class="nav dk">
                      ...
                      <li > <a href="users.php" class="auto"><i class="i i-dot"></i> <span>Users Approval</span> </a> </li>
                      
                     <!-- <li > <a href="users2.php" class="auto"><i class="i i-dot"></i> <span>CLP-OR Registration</span> </a> </li>
                      
                      <li > <a href="maintenancePK.php" class="auto"><i class="i i-dot"></i> <span>Maintenance Approval</span> </a> </li>-->
                      
                 <!--     <li > <a href="packageOR.php" class="auto"><i class="i i-dot"></i> <span>Additional Package Approval</span> </a> </li> -->
...
<li > <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="i i-grid2 icon"> </i> <span class="font-bold">Code Generator</span> </a>

                    <ul class="nav dk">
                    
                    <!--<li > <a href="#" class="auto"><i class="i i-dot"></i> <span>Member/Package</span> </a> </li>-->

                     <!-- <li > <a href="productcoupon.php" class="auto"><i class="i i-dot"></i> <span>Product/Uni-Level</span> </a> </li>-->


                    <li > <a href="prepaidactivation.php" class="auto"><i class="i i-dot"></i> <span>Prepaid Code</span> </a> </li>
