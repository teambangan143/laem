...
$prodcode=mysqli_real_escape_string($con,$_POST["prodcode"]);
...
<div class='alert alert-danger'>
	...
	print "
				...
				<script language='javascript'>
					...
					window.location = 'prodcodereggateway.php?username=$userid';
...
<?php include ("menu.php"); ?>
      ...
      <section id="content">
        ...
        <section class="hbox stretch">
          ...
          <header class="header bg-white b-b b-light">
            ...
            <p><strong>Product Code Registration| </strong>Please ask WeDo LifeStyle Administrator for Code. Available only to those members whoe purchased product. This code will accomulate under your Uni-Level.</p>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>" method="post">
		...
		<?php 
		  ...
		  <?php /*?><select name="package" placeholder="Select Package" required>
...
<input name="prodcode" type="text" class="form-control" placeholder="Enter Product Code" value="" maxlength="30">
		        ...
		        <button type="submit" class="btn btn-lg btn-primary btn-block">Register Code Under My Account</button>
